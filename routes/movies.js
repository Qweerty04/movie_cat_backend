...
router.get('/search', async (req, res) => {
    try {
        const query = req.query.q.trim(); // Get the search query from the request parameters
        ...
        }).select('releaseDate title landscapeImage _id'); // Only select the necessary fields
